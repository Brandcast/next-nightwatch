  ...
  '@tags' : ['filterspanel', 'brightness'],
    'Step 1: page load' : function (browser) {
      ...
      'Step 2: open filters panel and select brightness' : function (browser) {
        ...
        .waitForElementVisible('[data-automation-id="brightness-slider"]', 1000);
      ...
      'Step 3: select brightness via slider' : function (browser) { 
        browser.moveToElement('[data-automation-id="brightness-slider"]', 2,6)
        .mouseButtonDown(0)
        browser.moveToElement('[data-automation-id="brightness-slider"]', 15, 6)
        browser.moveToElement('[data-automation-id="brightness-slider"]', 50, 6)
        .mouseButtonUp(0)
      ...
      'Step 4: verify brightness is applied' : function (browser) { 
        browser.frame(0) //selects iframe - must call to select anything within iframe
