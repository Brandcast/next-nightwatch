  ...
  '@tags' : ['filterspanel', 'contrast'],
    'Step 1: page load' : function (browser) {
      ...
      'Step 2: open filters panel and select contrast' : function (browser) {
        ...
        .waitForElementVisible('[data-automation-id="contrast-slider"]', 1000);
      ...
      'Step 3: select contrast via slider' : function (browser) { 
        browser.moveToElement('[data-automation-id="contrast-slider"]', 2,6)
        .mouseButtonDown(0)
        browser.moveToElement('[data-automation-id="contrast-slider"]', 15, 6)
        browser.moveToElement('[data-automation-id="contrast-slider"]', 50, 6)
        .mouseButtonUp(0)
