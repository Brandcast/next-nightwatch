  ...
  '@tags' : ['filterspanel', 'invert'],
    'Step 1: page load' : function (browser) {
      ...
      'Step 2: open filters panel and select invert' : function (browser) {
        ...
        .waitForElementVisible('[data-automation-id="invert-slider"]', 1000);
      ...
      'Step 3: select invert via slider' : function (browser) { 
        browser.moveToElement('[data-automation-id="invert-slider"]', 2,6)
        .mouseButtonDown(0)
        browser.moveToElement('[data-automation-id="invert-slider"]', 15, 6)
        browser.moveToElement('[data-automation-id="invert-slider"]', 50, 6)
        .mouseButtonUp(0)
