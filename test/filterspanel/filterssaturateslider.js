  ...
  '@tags' : ['filterspanel', 'saturate'],
    'Step 1: page load' : function (browser) {
      ...
      'Step 2: open filters panel and select saturate' : function (browser) {
        ...
        .waitForElementVisible('[data-automation-id="saturate-slider"]', 1000);
      ...
      'Step 3: select saturate via slider' : function (browser) { 
        browser.moveToElement('[data-automation-id="saturate-slider"]', 2,6)
        .mouseButtonDown(0)
        browser.moveToElement('[data-automation-id="saturate-slider"]', 15, 6)
        browser.moveToElement('[data-automation-id="saturate-slider"]', 50, 6)
        .mouseButtonUp(0)
